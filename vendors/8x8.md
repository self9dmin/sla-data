...
support:
  tiers:
    ...
    - Enterprise
  has_24x7: true
  fastest_response: 30 min (S1, Premium/Enterprise)
  ...
  note: Enterprise lists a 30-min P1 target and a named support engineer; response times are targets, not credit-backed. Response targets are SLTs, not financially-backed SLAs. S1 phone is 24x7 all tiers; other severities regional business hours. Response targets are SLTs, not financially-backed SLAs. S1 phone is 24x7 all tiers; other severities regional business hours.
  channels:
    - phone
    - portal
    - chat
