...
global_exclusions:
  - No contractual uptime guarantee exists in the standard Terms of Service
  - 99.5% reliability figure is marketing-only, not a contractual commitment
  - Standard as-is / as-available warranty disclaimers apply
  - Any SLA terms are negotiated separately in enterprise contracts (not public)
support_tiers:
  - name: Standard
