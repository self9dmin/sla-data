...
claim_process:
  deadlines:
    - type: submission
      ...
      description: '"Customer must notify Notion in writing within 72 hours from the time of Downtime, and failure to provide such notice will forfeit the right to receive credit."'
...
support:
  ...
  note: Enterprise includes a CSM; Premium Support add-on adds 24/7 and a dedicated engineer. Email/help center (no confirmed phone). Around-the-clock support is Enterprise/Premium-Support-gated.
  channels:
    - email
    - portal
---
