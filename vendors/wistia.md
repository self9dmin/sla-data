...
claim_process:
  ...
  deadlines:
    - type: submission
      ...
      description: Must submit written claim within 10 days of discovering warranty breach
global_exclusions:
  - No numeric uptime commitment (commercially reasonable efforts only)
  - Sole remedy is re-performance or pro-rata refund at Wistia election
support_tiers:
  - name: Free
    price_model: Free
    sla_eligible: false
  ...
  - name: Advanced
    ...
    channels:
      ...
      - Dedicated support
services:
  - id: wistia-video-hosting
    name: Wistia Video Hosting
    category: Marketing & Analytics
