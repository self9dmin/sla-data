...
needs_review: true
review_note: >-
  Sauce Labs publishes no public uptime SLA or service-credit policy (current
  legal docs define only support response times), so all numeric SLA fields here
  are unverified.
